...
**Pre-implementation / research status.** Akashic is not yet an installable or usable product. This repository records the accepted product, architecture, security, and delivery baseline for an open-source, local-first Rust AI coding harness.
...
There are no installation or usage instructions yet. See [CONTRIBUTING.md](CONTRIBUTING.md) for documentation work during the research phase.
